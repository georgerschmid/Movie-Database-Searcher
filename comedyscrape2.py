...
for page in range(1000,2001,50): #we want to go through 10 pages
	r = requests.get(f'https://www.imdb.com/search/title/?genres=comedy&start={page}&explore=title_type,genres&ref_=adv_nxt', headers=headers)
...
movielist = [] #create an empty product list, to store each individual product
